...
export const caseStudy = {
  client: 'Climact',
  title: 'Une solution de site internet alternative',
  description:
    'Nous devions concevoir un site éco-responsable pour Climact, une entreprise de conseil en développement durable.',
  summary: [
